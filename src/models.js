...
export const MODELS_CONFIG = {
  ...
  // Claude Models
  'claude-sonnet-4-6': { name: 'claude-sonnet-4-5-20250929', provider: 'anthropic', vision: true },
  'claude-opus-4-6': { name: 'claude-opus-4-6', provider: 'anthropic', vision: true },
  'claude-opus-4-5-20251101': { name: 'claude-opus-4-5-20251101', provider: 'anthropic', vision: true },
  'claude-opus-4-5-20251101': { name: 'claude-opus-4-5-20251101', provider: 'anthropic', vision: true },

  // Google Models
  'gemini-3.1-pro-preview': { name: 'gemini-3-pro-preview', provider: 'google', vision: true },
  'gemini-3.1-flash-lite-preview': { name: 'gemini-3-pro-preview', provider: 'google', vision: true },
  'gemini-3-flash-preview': { name: 'gemini-3-pro-preview', provider: 'google', vision: true },
